...
{/* Here should appear a timeline including Menteepower, Mentorpower transactions 
 ...
 {/* Here should appear the list of all the courses mentee performed and also his progress. 
 Everything should be linked to an eosio explorer */}
 
				<div class="skills-container">
					<h3>Science</h3>
					<p>Cosmology and astronomy</p>
  					<div class="skills css">80%</div>
  					<h3>Computer Science</h3>
					<p>Blockchain development</p>
  					<div class="skills css1">40%</div>
  					<h3>Languages</h3>
					<p>French</p>
  					<div class="skills css2">70%</div>
				</div>
       </div>
    </div>	
